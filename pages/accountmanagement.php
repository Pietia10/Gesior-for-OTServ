...
else
{
	if($action == "")
	{
		...
		if($account_logged->getPremDays() > 0)
			$account_status = '<b><font color="green">Premium Account, ends '.date("l jS \of F Y", $account_logged->getCustomField("premend")).'</font></b>';
		else
