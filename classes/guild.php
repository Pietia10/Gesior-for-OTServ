...
class Guild extends ObjectData
{
	...
	public function getOwnerID(){return $this->data['owner_id'];}
	public function setOwnerID($value){$this->data['owner_id'] = $value;}
	public function getCreationData(){return $this->data['creationdate'];}
	public function setCreationData($value){$this->data['creationdate'] = $value;}
...
*/
	public function setCreateDate($value){$this->data['creationdate'] = $value;}
	public function getCreateDate(){return $this->data['creationdate'];}
