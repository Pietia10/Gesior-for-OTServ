...
class Account extends ObjectData
{
	...
	public function setPremDays($value){$this->data['premend'] = $value;}
	public function getPremDays(){return $this->data['premend'] - (date("z", time()) + (365 * (date("Y", time()) - date("Y", $this->data['lastday']))) - date("z", $this->data['lastday']));}
