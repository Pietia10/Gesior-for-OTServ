...
class House extends ObjectData
{
	...
	public function setTown($value){$this->data['townid'] = $value;}
	public function getTown(){return $this->data['townid'];}
	public function setSize($value){$this->data['tiles'] = $value;}
	public function getSize(){return $this->data['tiles'];}
